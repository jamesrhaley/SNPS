...
},{"./fromevent":3,"./transposition":7,"./virtual-hyperscript":9,"matches-selector":22,"rx":24,"vdom-parser":29,"virtual-dom/diff":36,"virtual-dom/patch":37}],6:[function(require,module,exports){
"use strict";
...
},{"./property-config":34,"escape-html":13}],33:[function(require,module,exports){
var escape = require('escape-html');
...
},{"../vnode/handle-thunk.js":49,"../vnode/is-vnode.js":52,"../vnode/is-vtext.js":53,"../vnode/is-widget.js":54,"./apply-properties":38,"global/document":15}],40:[function(require,module,exports){
...
},{"./create-element":39,"./dom-index":40,"./patch-op":41,"global/document":15,"x-is-array":61}],43:[function(require,module,exports){
var isWidget = require("../vnode/is-widget.js")
...
},{"ev-store":14}],46:[function(require,module,exports){
'use strict';
...
exports.pick = exports.target = exports.source = exports.d3nest = exports.ascending = exports.min = exports.sum = exports.Queue = exports.d3local = undefined;
...
},{"rx":24}],65:[function(require,module,exports){
'use strict';
...
//     .style("z-index", "-10")
//     .style("opacity", "0")
//     .html('No Results, please update filters'
//         + '<br>'
//         + 'ie: change sliders, unmouse select, or reset')
...
var radius = d3.scale.linear().domain([0, 10]);
...
var request$ = Observable.create(function (observer) {
  _sharedResource.d3local.csv(FILE, function (data) {
...
var filertedResult$ = Observable.combineLatest(sliderState$, request$, function (state, request) {
  var results = request.map(function (each) {
    ...
    return x.SNP_ID_CURRENT > state.low && x.SNP_ID_CURRENT < state.high;
  });
...
function intent(DOM) {
  ...
  var inputlow$ = mapAndStamp('.lowInput', 'low', 50);

  var slidehigh$ = mapAndStamp('.highSlider', 'high', 0);
  var inputhigh$ = mapAndStamp('.highInput', 'high', 50);
...
},{"./constants":63,"./resetButton":67,"@cycle/core":1,"@cycle/dom":2,"rx":24}],67:[function(require,module,exports){
'use strict';
...
},{"./constants":63,"./helpers/sharedResource":64,"rx":24}],68:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.makeCircles = undefined;
...
function makeCircles(parentObject, helpers, data) {
  return draw(".dot", parentObject, {
...
},{"./helpers/sharedResource":64,"rx":24}]},{},[65]);
